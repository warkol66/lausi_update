...
include_once 'lausi/Category.php';
...
abstract class BaseCategoryPeer {
	...
	const CLASS_DEFAULT = 'lausi.Category';
	...
	{
		include_once 'lausi/map/CategoryMapBuilder.php';
		return BasePeer::getMapBuilder('lausi.map.CategoryMapBuilder');
	}
	/**
	...
	const COUNT = 'COUNT(categories_category.ID)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT categories_category.ID)';
...
if (Propel::isInit()) {
	...
	require_once 'lausi/map/CategoryMapBuilder.php';
	Propel::registerMapBuilder('lausi.map.CategoryMapBuilder');
}

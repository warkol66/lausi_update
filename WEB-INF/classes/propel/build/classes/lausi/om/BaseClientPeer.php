...
// actual class may be a subclass -- as returned by ClientPeer::getOMClass()
include_once 'lausi/Client.php';
...
abstract class BaseClientPeer {
	...
	const CLASS_DEFAULT = 'lausi.Client';
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (ClientPeer::ID, ClientPeer::NAME, ClientPeer::CONTACT, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (ClientPeer::ID => 0, ClientPeer::NAME => 1, ClientPeer::CONTACT => 2, ),
	...
	{
		include_once 'lausi/map/ClientMapBuilder.php';
		return BasePeer::getMapBuilder('lausi.map.ClientMapBuilder');
	}
	/**
	...
	const COUNT = 'COUNT(lausi_client.ID)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT lausi_client.ID)';
	...
	public static function doInsert($values, $con = null)
	{
		...
		$criteria->remove(ClientPeer::ID); // remove pkey col since this table uses auto-increment
...
if (Propel::isInit()) {
	...
	require_once 'lausi/map/ClientMapBuilder.php';
	Propel::registerMapBuilder('lausi.map.ClientMapBuilder');
}

...
abstract class BaseModulePeer {
	...
	const CLASS_DEFAULT = 'lausi.Module';
	...
	{
		include_once 'lausi/map/ModuleMapBuilder.php';
		return BasePeer::getMapBuilder('lausi.map.ModuleMapBuilder');
	}
	/**
	...
	protected static function doOnDeleteCascade(Criteria $criteria, Connection $con)
	{
		...
		foreach($objects as $obj) {
			...
			include_once 'lausi/ModuleDependency.php';
...
if (Propel::isInit()) {
	...
	require_once 'lausi/map/ModuleMapBuilder.php';
	Propel::registerMapBuilder('lausi.map.ModuleMapBuilder');
}

...
abstract class BaseAffiliateUserGroupPeer {
	...
	const CLASS_DEFAULT = 'lausi.AffiliateUserGroup';
	...
	{
		include_once 'lausi/map/AffiliateUserGroupMapBuilder.php';
		return BasePeer::getMapBuilder('lausi.map.AffiliateUserGroupMapBuilder');
	}
	/**
...
if (Propel::isInit()) {
	...
	require_once 'lausi/map/AffiliateUserGroupMapBuilder.php';
	Propel::registerMapBuilder('lausi.map.AffiliateUserGroupMapBuilder');
}

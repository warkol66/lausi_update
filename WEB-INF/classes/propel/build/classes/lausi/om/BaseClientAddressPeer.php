...
// actual class may be a subclass -- as returned by ClientAddressPeer::getOMClass()
include_once 'lausi/ClientAddress.php';
...
abstract class BaseClientAddressPeer {
	...
	const CLASS_DEFAULT = 'lausi.ClientAddress';
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (ClientAddressPeer::ID, ClientAddressPeer::STREET, ClientAddressPeer::NUMBER, ClientAddressPeer::INTERSECTION, ClientAddressPeer::LATITUDE, ClientAddressPeer::LONGITUDE, ClientAddressPeer::TYPE, ClientAddressPeer::CIRCUITID, ClientAddressPeer::CLIENTID, ClientAddressPeer::REGIONID, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (ClientAddressPeer::ID => 0, ClientAddressPeer::STREET => 1, ClientAddressPeer::NUMBER => 2, ClientAddressPeer::INTERSECTION => 3, ClientAddressPeer::LATITUDE => 4, ClientAddressPeer::LONGITUDE => 5, ClientAddressPeer::TYPE => 6, ClientAddressPeer::CIRCUITID => 7, ClientAddressPeer::CLIENTID => 8, ClientAddressPeer::REGIONID => 9, ),
	...
	{
		include_once 'lausi/map/ClientAddressMapBuilder.php';
		return BasePeer::getMapBuilder('lausi.map.ClientAddressMapBuilder');
	}
	/**
	...
	public static function getPhpNameMap()
	{
		if (self::$phpNameMap === null) {
			$map = ClientAddressPeer::getTableMap();
	...
	const COUNT = 'COUNT(lausi_clientAddress.ID)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT lausi_clientAddress.ID)';
	...
	public static function doCount(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		if ($distinct || in_array(Criteria::DISTINCT, $criteria->getSelectModifiers())) {
			$criteria->addSelectColumn(ClientAddressPeer::COUNT_DISTINCT);
		} else {
			$criteria->addSelectColumn(ClientAddressPeer::COUNT);
		}
		...
		$rs = ClientAddressPeer::doSelectRS($criteria, $con);
		if ($rs->next()) {
			return $rs->getInt(1);
		} else {
	...
	{
		return ClientAddressPeer::populateObjects(ClientAddressPeer::doSelectRS($criteria, $con));
	}
	/**
	...
	public static function doCountJoinCircuit(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		$criteria->addJoin(ClientAddressPeer::CIRCUITID, CircuitPeer::ID);
	...
	public static function doCountJoinClient(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		$criteria->addJoin(ClientAddressPeer::CLIENTID, ClientPeer::ID);
	...
	public static function doCountJoinRegion(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		$criteria->addJoin(ClientAddressPeer::REGIONID, RegionPeer::ID);
	...
	public static function doSelectJoinCircuit(Criteria $c, $con = null)
	{
		...
		ClientAddressPeer::addSelectColumns($c);
		$startcol = (ClientAddressPeer::NUM_COLUMNS - ClientAddressPeer::NUM_LAZY_LOAD_COLUMNS) + 1;
		CircuitPeer::addSelectColumns($c);

		$c->addJoin(ClientAddressPeer::CIRCUITID, CircuitPeer::ID);
		$rs = BasePeer::doSelect($c, $con);
		$results = array();

		while($rs->next()) {

			$omClass = ClientAddressPeer::getOMClass();
			...
			foreach($results as $temp_obj1) {
				...
				if ($temp_obj2->getPrimaryKey() === $obj2->getPrimaryKey()) {
					...
					$temp_obj2->addClientAddress($obj1); //CHECKME
					break;
				}
			}
			if ($newObject) {
				$obj2->initClientAddresss();
				$obj2->addClientAddress($obj1); //CHECKME
			}
			$results[] = $obj1;
		}
		return $results;
	...
	public static function doSelectJoinClient(Criteria $c, $con = null)
	{
		...
		$c->addJoin(ClientAddressPeer::CLIENTID, ClientPeer::ID);
		$rs = BasePeer::doSelect($c, $con);
		$results = array();
	...
	public static function doSelectJoinRegion(Criteria $c, $con = null)
	{
		...
		$c->addJoin(ClientAddressPeer::REGIONID, RegionPeer::ID);
		$rs = BasePeer::doSelect($c, $con);
		$results = array();
	...
	public static function doSelectJoinAll(Criteria $c, $con = null)
	{
		...
		ClientAddressPeer::addSelectColumns($c);
		$startcol2 = (ClientAddressPeer::NUM_COLUMNS - ClientAddressPeer::NUM_LAZY_LOAD_COLUMNS) + 1;
		...
		RegionPeer::addSelectColumns($c);
		$startcol5 = $startcol4 + RegionPeer::NUM_COLUMNS;
		...
		while($rs->next()) {
			...
			for ($j=0, $resCount=count($results); $j < $resCount; $j++) {
				$temp_obj1 = $results[$j];
				$temp_obj3 = $temp_obj1->getClient(); // CHECKME
				if ($temp_obj3->getPrimaryKey() === $obj3->getPrimaryKey()) {
					$newObject = false;
					$temp_obj3->addClientAddress($obj1); // CHECKME
					break;
				}
			}

			if ($newObject) {
				$obj3->initClientAddresss();
			...
			for ($j=0, $resCount=count($results); $j < $resCount; $j++) {
				$temp_obj1 = $results[$j];
				$temp_obj4 = $temp_obj1->getRegion(); // CHECKME
				if ($temp_obj4->getPrimaryKey() === $obj4->getPrimaryKey()) {
					$newObject = false;
					$temp_obj4->addClientAddress($obj1); // CHECKME
					break;
				}
			}

			if ($newObject) {
				$obj4->initClientAddresss();
	...
	public static function doSelectJoinAllExceptCircuit(Criteria $c, $con = null)
	{
		...
		while($rs->next()) {
			...
			for ($j=0, $resCount=count($results); $j < $resCount; $j++) {
				...
				if ($temp_obj2->getPrimaryKey() === $obj2->getPrimaryKey()) {
					$newObject = false;
					$temp_obj2->addClientAddress($obj1);
					break;
				}
			}
			...
			for ($j=0, $resCount=count($results); $j < $resCount; $j++) {
				...
				if ($temp_obj3->getPrimaryKey() === $obj3->getPrimaryKey()) {
					$newObject = false;
					$temp_obj3->addClientAddress($obj1);
					break;
				}
			}
	...
	{
		return ClientAddressPeer::CLASS_DEFAULT;
	}
	...
	public static function doInsert($values, $con = null)
	{
		...
		$criteria->remove(ClientAddressPeer::ID); // remove pkey col since this table uses auto-increment
	...
	public static function doUpdate($values, $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$selectCriteria->add(ClientAddressPeer::ID, $criteria->remove(ClientAddressPeer::ID), $comparison);
	...
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->begin();
			$affectedRows += BasePeer::doDeleteAll(ClientAddressPeer::TABLE_NAME, $con);
			$con->commit();
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollback();
	 ...
	 */
	 public static function doDelete($values, $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			$criteria = clone $values; // rename for clarity
		} elseif ($values instanceof ClientAddress) {
	 ...
	 */
	public static function doValidate(ClientAddress $obj, $cols = null)
	{
		$columns = array();
...
if (Propel::isInit()) {
	...
	try {
		BaseClientAddressPeer::getMapBuilder();
	} catch (Exception $e) {
	...
	require_once 'lausi/map/ClientAddressMapBuilder.php';
	Propel::registerMapBuilder('lausi.map.ClientAddressMapBuilder');
}

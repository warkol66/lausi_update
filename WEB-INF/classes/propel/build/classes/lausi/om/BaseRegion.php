...
include_once 'lausi/RegionPeer.php';
...
abstract class BaseRegion extends BaseObject  implements Persistent {
	 ...
	 */
	public function getAddresssJoinCircuit($criteria = null, $con = null)
	{
		// include the Peer class
		include_once 'lausi/om/BaseAddressPeer.php';
		if ($criteria === null) {
		...
		if ($this->collAddresss === null) {
			if ($this->isNew()) {
				...
				$this->collAddresss = AddressPeer::doSelectJoinCircuit($criteria, $con);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
		...
		if ($this->collClientAddresss === null) {
			if ($this->isNew()) {
			   $this->collClientAddresss = array();
				...
				$criteria->add(ClientAddressPeer::REGIONID, $this->getId());

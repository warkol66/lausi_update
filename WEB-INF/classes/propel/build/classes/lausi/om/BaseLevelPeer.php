...
abstract class BaseLevelPeer {
	...
	const CLASS_DEFAULT = 'lausi.Level';
	...
	{
		include_once 'lausi/map/LevelMapBuilder.php';
		return BasePeer::getMapBuilder('lausi.map.LevelMapBuilder');
	}
	/**
...
if (Propel::isInit()) {
	...
	require_once 'lausi/map/LevelMapBuilder.php';
	Propel::registerMapBuilder('lausi.map.LevelMapBuilder');
}

...
abstract class BaseRegionPeer {
	...
	const CLASS_DEFAULT = 'lausi.Region';
	...
	{
		include_once 'lausi/map/RegionMapBuilder.php';
		return BasePeer::getMapBuilder('lausi.map.RegionMapBuilder');
	}
	/**
	...
	const COUNT = 'COUNT(lausi_region.ID)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT lausi_region.ID)';
	...
	public static function doInsert($values, $con = null)
	{
		...
		$criteria->remove(RegionPeer::ID); // remove pkey col since this table uses auto-increment
...
if (Propel::isInit()) {
	...
	require_once 'lausi/map/RegionMapBuilder.php';
	Propel::registerMapBuilder('lausi.map.RegionMapBuilder');
}

...
// actual class may be a subclass -- as returned by WorkforcePeer::getOMClass()
include_once 'lausi/Workforce.php';
...
abstract class BaseWorkforcePeer {
	...
	const CLASS_DEFAULT = 'lausi.Workforce';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'Telephone', 'Workinheight', ),
		BasePeer::TYPE_COLNAME => array (WorkforcePeer::ID, WorkforcePeer::NAME, WorkforcePeer::TELEPHONE, WorkforcePeer::WORKINHEIGHT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'telephone', 'workInHeight', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'Telephone' => 2, 'Workinheight' => 3, ),
		BasePeer::TYPE_COLNAME => array (WorkforcePeer::ID => 0, WorkforcePeer::NAME => 1, WorkforcePeer::TELEPHONE => 2, WorkforcePeer::WORKINHEIGHT => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'telephone' => 2, 'workInHeight' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
	...
	{
		include_once 'lausi/map/WorkforceMapBuilder.php';
		return BasePeer::getMapBuilder('lausi.map.WorkforceMapBuilder');
	}
	/**
	...
	const COUNT = 'COUNT(lausi_workforce.ID)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT lausi_workforce.ID)';
	...
	public static function doCount(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		if ($distinct || in_array(Criteria::DISTINCT, $criteria->getSelectModifiers())) {
			$criteria->addSelectColumn(WorkforcePeer::COUNT_DISTINCT);
		} else {
			$criteria->addSelectColumn(WorkforcePeer::COUNT);
		}
		...
		$rs = WorkforcePeer::doSelectRS($criteria, $con);
		if ($rs->next()) {
			return $rs->getInt(1);
		} else {
	...
	{
		return WorkforcePeer::populateObjects(WorkforcePeer::doSelectRS($criteria, $con));
	}
	/**
	...
	{
		return WorkforcePeer::CLASS_DEFAULT;
	}
	...
	public static function doInsert($values, $con = null)
	{
		...
		$criteria->remove(WorkforcePeer::ID); // remove pkey col since this table uses auto-increment
	...
	public static function doUpdate($values, $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$selectCriteria->add(WorkforcePeer::ID, $criteria->remove(WorkforcePeer::ID), $comparison);
	...
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->begin();
			$affectedRows += BasePeer::doDeleteAll(WorkforcePeer::TABLE_NAME, $con);
			$con->commit();
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollback();
	 ...
	 */
	public static function doValidate(Workforce $obj, $cols = null)
	{
		$columns = array();
...
if (Propel::isInit()) {
	...
	try {
		BaseWorkforcePeer::getMapBuilder();
	} catch (Exception $e) {
	...
	require_once 'lausi/map/WorkforceMapBuilder.php';
	Propel::registerMapBuilder('lausi.map.WorkforceMapBuilder');
}

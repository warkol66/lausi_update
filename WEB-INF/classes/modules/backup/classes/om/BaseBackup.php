...
/**
 * Base class that represents a row from the 'backup_log' table.
 *
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					if ($criteria->keyContainsValue(BackupPeer::ID) ) {
					...
					$affectedRows = BackupPeer::doUpdate($this, $con);
				}

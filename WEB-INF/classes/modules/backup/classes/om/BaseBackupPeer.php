...
/**
 * Base static class for performing query and update operations on the 'backup_log' table.
 *
...
abstract class BaseBackupPeer {
	...
	const TABLE_NAME = 'backup_log';

	/** the related Propel class for this table */
	const OM_CLASS = 'Backup';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'backup.classes.Backup';

	/** the related TableMap class for this table */
	const TM_CLASS = 'BackupTableMap';
	...
	const ID = 'backup_log.ID';

	/** The default string format for model objects of the related table **/
	const DEFAULT_STRING_FORMAT = 'YAML';
	
	/**
	 * An identiy map to hold any loaded instances of Backup objects.
	 ...
	 *
	 * @param      Backup $value A Backup object.
	...
	/**
	 * Method to invalidate the instance pool of all tables related to backup_log
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		$cls = BackupPeer::getOMClass(false);
	...
	public static function populateObject($row, $startcol = 0)
	{
		...
		if (null !== ($obj = BackupPeer::getInstanceFromPool($key))) {
			...
			$col = $startcol + BackupPeer::NUM_COLUMNS;
		} else {
	...
	public static function buildTableMap()
	{
	  ...
	  {
	    $dbMap->addTableObject(new BackupTableMap());
	  }
	}
	...
	{
		return $withPrefix ? BackupPeer::CLASS_DEFAULT : BackupPeer::OM_CLASS;
	}

	/**
	 * Method perform an INSERT on the database, given a Backup or Criteria object.
	 *
	...
	/**
	 * Method perform an UPDATE on the database, given a Backup or Criteria object.
	 *
	...
	/**
	 * Method to DELETE all rows from the backup_log table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	/**
	 * Method perform a DELETE on the database, given a Backup or Criteria object OR a primary key value.
	 *

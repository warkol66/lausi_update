...
/**
 * Base static class for performing query and update operations on the 'lausi_region' table.
 *
 * Barrios
 *
...
abstract class BaseRegionPeer {
	...
	const TABLE_NAME = 'lausi_region';

	/** the related Propel class for this table */
	const OM_CLASS = 'Region';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'lausi.classes.Region';
	...
	/**
	 * Method to invalidate the instance pool of all tables related to lausi_region
	...
	/**
	 * Method to DELETE all rows from the lausi_region table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */

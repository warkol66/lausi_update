...
abstract class BaseThemePeer {
	...
	const CLASS_DEFAULT = 'lausi.classes.Theme';
	...
	protected static $fieldNames = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'shortname', 'startdate', 'duration', 'sheetstotal', 'type', 'active', 'clientid', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::NAME, self::SHORTNAME, self::STARTDATE, self::DURATION, self::SHEETSTOTAL, self::TYPE, self::ACTIVE, self::CLIENTID, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NAME', 'SHORTNAME', 'STARTDATE', 'DURATION', 'SHEETSTOTAL', 'TYPE', 'ACTIVE', 'CLIENTID', ),
	...
	protected static $fieldKeys = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'shortname' => 2, 'startdate' => 3, 'duration' => 4, 'sheetstotal' => 5, 'type' => 6, 'active' => 7, 'clientid' => 8, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NAME => 1, self::SHORTNAME => 2, self::STARTDATE => 3, self::DURATION => 4, self::SHEETSTOTAL => 5, self::TYPE => 6, self::ACTIVE => 7, self::CLIENTID => 8, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NAME' => 1, 'SHORTNAME' => 2, 'STARTDATE' => 3, 'DURATION' => 4, 'SHEETSTOTAL' => 5, 'TYPE' => 6, 'ACTIVE' => 7, 'CLIENTID' => 8, ),
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn($alias . '.SHEETSTOTAL');
	...
	/**
	 * Method to invalidate the instance pool of all tables related to lausi_theme
	...
	public static function doSelectJoinClient(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			$key1 = ThemePeer::getPrimaryKeyHashFromRow($row, 0);
			if (null !== ($obj1 = ThemePeer::getInstanceFromPool($key1))) {
				// We no longer rehydrate the object, since this can cause data loss.
				// See http://www.propelorm.org/ticket/509
				...
				$obj1 = new $cls();
				$obj1->hydrate($row);
				ThemePeer::addInstanceToPool($obj1, $key1);
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Theme) to $obj2 (Client)
				$obj2->addTheme($obj1);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Theme) to the collection in $obj2 (Client)
				$obj2->addTheme($obj1);
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			$c = clone $criteria;
			$affectedRows += ThemePeer::doOnDeleteCascade($c, $con);
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			$criteria->add(AdvertisementPeer::THEMEID, $obj->getId());

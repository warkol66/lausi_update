...
/**
 * Base class that represents a row from the 'lausi_circuit' table.
 *
 * Base de Circuitos
 *
 * @package    propel.generator.lausi.classes.om
 */
abstract class BaseCircuit extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'CircuitPeer';
	...
	/**
	 * The value for the limitsdescription field.
	 * @var        string
	 */
	protected $limitsdescription;

	/**
	 * The value for the orderby field.
	 * @var        int
	 */
	protected $orderby;
	...
	{
		return $this->limitsdescription;
	}

	/**
	 * Get the [orderby] column value.
	 * Orden del Circuito
	 * @return     int
	 */
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = CircuitPeer::ID;
		}
	...
	public function setName($v)
	{
		...
		if ($this->name !== $v) {
			$this->name = $v;
			$this->modifiedColumns[] = CircuitPeer::NAME;
		}
	...
	public function setDescription($v)
	{
		...
		if ($this->description !== $v) {
			$this->description = $v;
			$this->modifiedColumns[] = CircuitPeer::DESCRIPTION;
		}
	 ...
	 * @return     Circuit The current object (for fluent API support)
	 */
	public function setLimitsdescription($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->limitsdescription !== $v) {
			$this->limitsdescription = $v;
			$this->modifiedColumns[] = CircuitPeer::LIMITSDESCRIPTION;
		}

		return $this;
	} // setLimitsdescription()

	/**
	 * Set the value of [orderby] column.
	 * Orden del Circuito
	 * @param      int $v new value
	 * @return     Circuit The current object (for fluent API support)
	 */
	public function setOrderby($v)
	{
		...
		if ($this->orderby !== $v) {
			$this->orderby = $v;
			$this->modifiedColumns[] = CircuitPeer::ORDERBY;
		}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = CircuitPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				CircuitPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					if ($criteria->keyContainsValue(CircuitPeer::ID) ) {
					...
					$affectedRows = CircuitPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = CircuitPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = CircuitPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['Circuit'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['Circuit'][$this->getPrimaryKey()] = true;
		$keys = CircuitPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getName(),
	...
	{
		$criteria = new Criteria(CircuitPeer::DATABASE_NAME);
		$criteria->add(CircuitPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Circuit (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Circuit Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 * @return     PropelCollection|array WorkforceCircuit[] List of WorkforceCircuit objects
	 */
	public function getWorkforceCircuitsJoinWorkforce($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = WorkforceCircuitQuery::create(null, $criteria);
	 ...
	 * @return     PropelCollection|array Address[] List of Address objects
	 */
	public function getAddresssJoinRegion($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = AddressQuery::create(null, $criteria);
	 ...
	 * @return     PropelCollection|array ClientAddress[] List of ClientAddress objects
	 */
	public function getClientAddresssJoinClient($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = ClientAddressQuery::create(null, $criteria);
	...
	{
		return (string) $this->exportTo(CircuitPeer::DEFAULT_STRING_FORMAT);
	}

...
class LausiReportsDeletedAddressesAction extends BaseAction {


	// ----- Constructor ---------------------------------------------------- //

	function LausiReportsDeletedAddressesAction() {
		;
	}
   	...
   	BaseAction::execute($mapping, $form, $request, $response);
		...
		if (!empty($_GET['reportMode'])) {
			...
			if ($_GET['reportMode'] == 'normal') {
				...
				$addresses = $addressPeer->getAll();//$addressPeer->getAllFiltered($_GET["page"]);

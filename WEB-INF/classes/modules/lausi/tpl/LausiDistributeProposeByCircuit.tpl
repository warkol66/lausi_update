...
<div id="circuit-|-$circuit->getId()-|">

	<table id="tabla-addresses" width='100%' border="0" cellpadding='5' cellspacing='0' class='tableTdBorders'>
		<thead>
			<tr>
				 <th colspan="4" class="thFillTitle">Distribución en Ubicaciones: Circuito |-$circuit->getName()-| [A distribuir: <span id="to-be-distributed-|-$circuit->getId()-|">##</span>]</th>
			</tr>
	...
	<br />
|-/foreach-|
|-include file="LausiDistributeProposeCheckboxCountInclude.tpl" type="circuit"-|

...
<form id="form|-$rating-|"method="post">
	...
	<table id="tabla-addresses" width='100%' border="0" cellpadding='5' cellspacing='0' class='tableTdBorders'>
		<thead>
			<tr>
				 <th colspan="3" class="thFillTitle">Distribución en Ubicaciones: |-if $rating eq 1-|Premium
		...
		<tbody>
			<tr>
				 <th colspan="3" class="thFillTitle">No hay disponibilidad para esta valoración</th>
			</tr>
		</tbody>
		|-else-|
			<tr>

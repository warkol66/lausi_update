...
<div id="rating-|-$rating-|">
		...
		<thead>
			<tr>
				 <th colspan="4" class="thFillTitle">Distribución en Ubicaciones: |-if $rating eq 1-|Premium
						...
						|-/if-|
						[A distribuir: <span id="to-be-distributed-|-$rating-|">##</span>]
				</th>
			</tr>
	...
	<br />
|-/foreach-|
|-include file="LausiDistributeProposeCheckboxCountInclude.tpl" type="rating" uniqueId=$result.rating-|

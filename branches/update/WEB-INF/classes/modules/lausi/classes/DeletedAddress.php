...
/**
 * Skeleton subclass for representing a row from the 'lausi_deletedAddress' table.
 *
 ...
 */
class DeletedAddress extends BaseDeletedAddress
{
	...
	/**
	 * Devuelve el proximo numero de cartelera en la direccion
	 *
	 * @return integer proximo numero de cartelera en la direccion
	 */
	...
	/**
	 * Devuelve la cantidad de carteleras por tipo en cada direccion

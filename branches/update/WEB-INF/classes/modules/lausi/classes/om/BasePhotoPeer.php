...
/**
 * Base static class for performing query and update operations on the 'lausi_photo' table.
 *
 * Base de Fotos
 *
...
abstract class BasePhotoPeer {
	...
	const TABLE_NAME = 'lausi_photo';

	/** the related Propel class for this table */
	const OM_CLASS = 'Photo';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'lausi.classes.Photo';
	...
	const ID = 'lausi_photo.ID';

	/** the column name for the NAME field */
	const NAME = 'lausi_photo.NAME';

	/** the column name for the TYPE field */
	const TYPE = 'lausi_photo.TYPE';

	/** the column name for the FILENAME field */
	const FILENAME = 'lausi_photo.FILENAME';
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'Type', 'Filename', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'type', 'filename', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::NAME, self::TYPE, self::FILENAME, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NAME', 'TYPE', 'FILENAME', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'type', 'filename', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'Type' => 2, 'Filename' => 3, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'type' => 2, 'filename' => 3, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NAME => 1, self::TYPE => 2, self::FILENAME => 3, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NAME' => 1, 'TYPE' => 2, 'FILENAME' => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'type' => 2, 'filename' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(PhotoPeer::TYPE);
	...
	/**
	 * Method to invalidate the instance pool of all tables related to lausi_photo
	...
	/**
	 * Method to DELETE all rows from the lausi_photo table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */

...
/**
 * Base static class for performing query and update operations on the 'lausi_client' table.
 *
 * Base de Clientes
 *
...
abstract class BaseClientPeer {
	...
	const TABLE_NAME = 'lausi_client';

	/** the related Propel class for this table */
	const OM_CLASS = 'Client';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'lausi.classes.Client';
	...
	const ID = 'lausi_client.ID';

	/** the column name for the NAME field */
	const NAME = 'lausi_client.NAME';

	/** the column name for the CONTACT field */
	const CONTACT = 'lausi_client.CONTACT';
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'Contact', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'contact', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::NAME, self::CONTACT, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NAME', 'CONTACT', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'contact', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'Contact' => 2, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'contact' => 2, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NAME => 1, self::CONTACT => 2, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NAME' => 1, 'CONTACT' => 2, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'contact' => 2, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);
	...
	/**
	 * Method to invalidate the instance pool of all tables related to lausi_client
	...
	public static function populateObject($row, $startcol = 0)
	{
		...
		if (null !== ($obj = ClientPeer::getInstanceFromPool($key))) {
			...
			$col = $startcol + ClientPeer::NUM_COLUMNS;
		} else {
	...
	/**
	 * Method to DELETE all rows from the lausi_client table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */

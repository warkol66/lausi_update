...
class LausiThemesProposeRotationXAction extends BaseAction {
	...
	function LausiThemesProposeRotationXAction() {
		;
	}
	...
	*/
    ...
    BaseAction::execute($mapping, $form, $request, $response);
		...
		if (isset($_POST['advertId']) && isset($_POST['themeId'])) {
			...
			//TODO lo pasa exactamente igual.

			$result = $proposalGenerator->generateProposal($_POST['themeId'], $advert->getPublishDate(), $advert->getDuration());

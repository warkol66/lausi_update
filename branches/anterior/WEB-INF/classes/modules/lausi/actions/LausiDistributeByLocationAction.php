...
class LausiDistributeByLocationAction extends BaseAction {


	// ----- Constructor ---------------------------------------------------- //

	function LausiDistributeByLocationAction() {
		;
	}
	...
	*/
	function execute($mapping, $form, &$request, &$response) {
		...
		//obtenemos todas las direcciones de clientes importantes
		$smarty->assign('clientAddresses',ClientAddressPeer::getAll());

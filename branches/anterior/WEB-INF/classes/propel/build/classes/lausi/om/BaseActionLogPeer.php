...
include_once 'lausi/ActionLog.php';
...
abstract class BaseActionLogPeer {
	...
	const CLASS_DEFAULT = 'lausi.ActionLog';
	...
	{
		include_once 'lausi/map/ActionLogMapBuilder.php';
		return BasePeer::getMapBuilder('lausi.map.ActionLogMapBuilder');
	}
	/**
...
if (Propel::isInit()) {
	...
	require_once 'lausi/map/ActionLogMapBuilder.php';
	Propel::registerMapBuilder('lausi.map.ActionLogMapBuilder');
}

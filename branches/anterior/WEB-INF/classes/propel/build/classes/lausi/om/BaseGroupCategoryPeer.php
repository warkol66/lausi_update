...
abstract class BaseGroupCategoryPeer {
	...
	const CLASS_DEFAULT = 'lausi.GroupCategory';
	...
	{
		include_once 'lausi/map/GroupCategoryMapBuilder.php';
		return BasePeer::getMapBuilder('lausi.map.GroupCategoryMapBuilder');
	}
	/**
...
if (Propel::isInit()) {
	...
	require_once 'lausi/map/GroupCategoryMapBuilder.php';
	Propel::registerMapBuilder('lausi.map.GroupCategoryMapBuilder');
}

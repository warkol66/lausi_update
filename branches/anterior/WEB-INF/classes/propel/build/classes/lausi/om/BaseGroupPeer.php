...
abstract class BaseGroupPeer {
	...
	const CLASS_DEFAULT = 'lausi.Group';
	...
	{
		include_once 'lausi/map/GroupMapBuilder.php';
		return BasePeer::getMapBuilder('lausi.map.GroupMapBuilder');
	}
	/**
	...
	protected static function doOnDeleteCascade(Criteria $criteria, Connection $con)
	{
		...
		foreach($objects as $obj) {
			...
			include_once 'lausi/UserGroup.php';
			...
			include_once 'lausi/GroupCategory.php';
...
if (Propel::isInit()) {
	...
	require_once 'lausi/map/GroupMapBuilder.php';
	Propel::registerMapBuilder('lausi.map.GroupMapBuilder');
}
